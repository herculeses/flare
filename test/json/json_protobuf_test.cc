...
#include "json/message.pb.h"
#include "json/addressbook1.pb.h"
#include "json/addressbook.pb.h"
#include "json/addressbook_encode_decode.pb.h"
#include "json/addressbook_map.pb.h"
...
namespace {  // just for coding-style check
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_normal_case) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            const bool ret = flare::json2pb::json_to_proto_message(info3, &data, &error);
            ...
            bool ret2 = flare::json2pb::proto_message_to_json(data, &info4, &error1);
    ...
    TEST_F(ProtobufJsonTest, json_base64_string_to_pb_types_case) {
        ...
        JsonContextBody data;
        flare::json2pb::json_to_pb_options options_j2pb;
        options_j2pb.base64_to_bytes = true;
        const bool ret = flare::json2pb::json_to_proto_message(info3, &data, options_j2pb, &error);
        ASSERT_TRUE(ret);
        ...
        std::string info4;
        std::string error1;
        flare::json2pb::proto_to_json_options options_pb2j;
        options_pb2j.bytes_to_base64 = true;
        bool ret2 = flare::json2pb::proto_message_to_json(data, &info4, options_pb2j, &error1);
        ASSERT_TRUE(ret2);
#ifndef RAPIDJSON_VERSION_0_1
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_map_case) {
        ...
        std::string error;
        AddressNoMap ab1;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab1, &error));
        ASSERT_EQ("baidu.com", ab1.addr());

        AddressIntMap ab2;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab2, &error));
        ...
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab3, &error));
        ...
        AddressComplex ab4;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab4, &error)) << error;
        ...
        ab2.Clear();
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(old_json, &ab2, &error)) << error;
        ASSERT_EQ("baidu.com", ab2.addr());
        ASSERT_EQ("tel", ab2.numbers(0).key());
        ASSERT_EQ(123456, ab2.numbers(0).value());
        ASSERT_EQ("cell", ab2.numbers(1).key());
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_encode_decode) {
        ...
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(info3, &data, &error));

        std::string info4;
        std::string error1;
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(data, &info4, &error1));
#ifndef RAPIDJSON_VERSION_0_1
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_unicode_case) {
        ...
        bool ret = flare::json2pb::proto_message_to_json(address_book, &info1, &error);
        ASSERT_TRUE(ret);
        AddressBook address_book_test;
        ret = flare::json2pb::json_to_proto_message(info1, &address_book_test, &error);
        ASSERT_TRUE(ret);
        std::string info2;
        ret = flare::json2pb::proto_message_to_json(address_book_test, &info2, &error);
        ASSERT_TRUE(ret);
        ASSERT_TRUE(!info1.compare(info2));
        flare::cord_buf buf;
        flare::cord_buf_as_zero_copy_output_stream stream(&buf);
        bool res = flare::json2pb::proto_message_to_json(address_book, &stream, NULL);
        ASSERT_TRUE(res);
        flare::cord_buf_as_zero_copy_input_stream stream2(buf);
        AddressBook address_book_test3;
        ret = flare::json2pb::json_to_proto_message(&stream2, &address_book_test3, &error);
        ASSERT_TRUE(ret);
        std::string info3;
        ret = flare::json2pb::proto_message_to_json(address_book_test3, &info3, &error);
        ASSERT_TRUE(ret);
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_edge_case) {
        ...
        std::string error;
        JsonContextBody data;
        bool ret = flare::json2pb::json_to_proto_message(info3, &data, &error);
        ASSERT_TRUE(ret);

        std::string info4;
        std::string error1;
        ret = flare::json2pb::proto_message_to_json(data, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data1, &error);
        ASSERT_TRUE(ret);

        info4.clear();
        error1.clear();
        ret = flare::json2pb::proto_message_to_json(data1, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data2, &error);
        ASSERT_TRUE(ret);

        info4.clear();
        error1.clear();
        ret = flare::json2pb::proto_message_to_json(data2, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data3, &error);
        ASSERT_TRUE(ret);

        info4.clear();
        error1.clear();
        ret = flare::json2pb::proto_message_to_json(data3, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data4, &error);
        ASSERT_TRUE(ret);

        info4.clear();
        error1.clear();
        ret = flare::json2pb::proto_message_to_json(data4, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data5, &error);
        ASSERT_TRUE(ret);

        info4.clear();
        error1.clear();
        ret = flare::json2pb::proto_message_to_json(data5, &info4, &error1);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data9, &error);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data10, &error);
        ASSERT_TRUE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data11, &error);
        ASSERT_TRUE(ret);
        ASSERT_STREQ(
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_expected_failed_case) {
        ...
        JsonContextBody data3;
        ret = flare::json2pb::json_to_proto_message(info3, &data, &error);
        ASSERT_FALSE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data6, &error);
        ASSERT_FALSE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data7, &error);
        ASSERT_FALSE(ret);
        ...
        ret = flare::json2pb::json_to_proto_message(info3, &data8, &error);
        ASSERT_FALSE(ret);
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_perf_case) {
        ...
        for (int i = 0; i < times; i++) {
            JsonContextBody data;
            timer.start();
            res = flare::json2pb::json_to_proto_message(info3, &data, &error);
            timer.stop();
            ...
            std::string error1;
            timer.start();
            res = flare::json2pb::proto_message_to_json(data, &info4, &error1);
            timer.stop();
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_complex_perf_case) {
        ...
        flare::json2pb::json_to_pb_options options;
        options.base64_to_bytes = false;
        ProfilerStart("json_to_pb_complex_perf.prof");
        for (int i = 0; i < times; i++) {
            gss::message::gss_us_res_t data;
            flare::cord_buf_as_zero_copy_input_stream stream(buf);
            timer.start();
            res = flare::json2pb::json_to_proto_message(&stream, &data, options, &error);
            timer.stop();
            avg_time1 += timer.u_elapsed();
    ...
    TEST_F(ProtobufJsonTest, json_to_pb_to_string_complex_perf_case) {
        ...
        for (int i = 0; i < times; i++) {
            gss::message::gss_us_res_t data;
            timer.start();
            res = flare::json2pb::json_to_proto_message(info3, &data, options, &error);
            timer.stop();
            avg_time1 += timer.u_elapsed();
            ASSERT_TRUE(res);
        }
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_normal_case) {
        ...
        printf("----------test pb to json------------\n\n");
        flare::json2pb::proto_to_json_options option;
        option.bytes_to_base64 = true;
        bool ret = flare::json2pb::proto_message_to_json(address_book, &info1, option, NULL);
        ASSERT_TRUE(ret);
        ...
        info1.clear();
        {
            flare::json2pb::proto_to_json_options option;
            option.bytes_to_base64 = true;
            ret = proto_message_to_json(address_book, &info1, option, NULL);
        }
        ASSERT_TRUE(ret);
        ...
        info1.clear();
        {
            flare::json2pb::proto_to_json_options option;
            option.bytes_to_base64 = true;
            option.enum_option = flare::json2pb::OUTPUT_ENUM_BY_NUMBER;
            ret = proto_message_to_json(address_book, &info1, option, NULL);
        }
        ASSERT_TRUE(ret);
        ...
        for (int i = 0; i < N; ++i) {
            ...
            std::string error1;
            const int64_t tm1 = gettimeofday_us();
            bool ret1 = flare::json2pb::json_to_proto_message(info1, &data1, &error1);
            const int64_t tm2 = gettimeofday_us();
            total_tm += tm2 - tm1;
            ASSERT_TRUE(ret1);
            ...
            std::string error2;
            const int64_t tm3 = gettimeofday_us();
            ret1 = flare::json2pb::proto_message_to_json(data1, &info3, &error2);
            const int64_t tm4 = gettimeofday_us();
            ASSERT_TRUE(ret1);
            total_tm2 += tm4 - tm3;
#ifndef RAPIDJSON_VERSION_0_1
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_map_case) {
        ...
        AddressNoMap ab1;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab1, &error));
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(ab1, &output, &error));
        ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);

        output.clear();
        AddressIntMap ab2;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab2, &error));
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(ab2, &output, &error));
        ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
        ...
        AddressStringMap ab3;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab3, &error));
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(ab3, &output, &error));
        ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
        ...
        output.clear();
        AddressComplex ab4;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &ab4, &error));
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(ab4, &output, &error));
        ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_encode_decode) {
        ...
        flare::json2pb::proto_to_json_options option;
        option.bytes_to_base64 = true;
        ASSERT_TRUE(proto_message_to_json(json_data, &info1, option, NULL));
#ifndef RAPIDJSON_VERSION_0_1
        ...
        std::string info3;
        JsonContextBody data1;
        flare::json2pb::json_to_proto_message(info1, &data1, NULL);
        flare::json2pb::proto_message_to_json(data1, &info3, NULL);
#ifndef RAPIDJSON_VERSION_0_1
        ASSERT_STREQ("{\"info\":[\"this is json data's info\",\"this is a test\"],\"type\":80000,"
                     "\"data:array\":[200,300],\"judge\":true,\"spur\":3.45,\"@Content_Test%@\":"
                     "[{\"uid*\":\"content info\",\"Distance_info_\":1234.56005859375,\"_ext%T_\":"
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_edge_case) {
        ...
        ret = flare::json2pb::proto_message_to_json(address_book, &info1, &error);
        ...
        std::string error2;
        bool ret2 = flare::json2pb::proto_message_to_json(data1, &info3, &error2);
        ASSERT_TRUE(ret2);
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_perf_case) {
        ...
        float avg_time2 = 0;
        const int times = 100000;
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(address_book, &info1, NULL));
        for (int i = 0; i < times; i++) {
            std::string info3;
            AddressBook data1;
            timer.start();
            res = flare::json2pb::json_to_proto_message(info1, &data1, NULL);
            timer.stop();
            avg_time1 += timer.u_elapsed();
            ASSERT_TRUE(res);

            timer.start();
            res = flare::json2pb::proto_message_to_json(data1, &info3, NULL);
            timer.stop();
            avg_time2 += timer.u_elapsed();
            ASSERT_TRUE(res);
        }
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_encode_decode_perf_case) {
        ...
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(json_data, &info1, NULL));
        ...
        for (int i = 0; i < times; i++) {
            ...
            timer.start();
            res = flare::json2pb::json_to_proto_message(info1, &json_body, NULL);
            timer.stop();
            avg_time1 += timer.u_elapsed();
            ASSERT_TRUE(res);

            timer.start();
            res = flare::json2pb::proto_message_to_json(json_body, &info3, NULL);
            timer.stop();
            avg_time2 += timer.u_elapsed();
            ASSERT_TRUE(res);
        }
    ...
    TEST_F(ProtobufJsonTest, pb_to_json_complex_perf_case) {
        ...
        const int times = 10000;
        gss::message::gss_us_res_t data;
        flare::json2pb::json_to_pb_options option;
        option.base64_to_bytes = false;
        timer.start();
        res = json_to_proto_message(info3, &data, option, &error);
        timer.stop();
        avg_time1 += timer.u_elapsed();
        ASSERT_TRUE(res) << error;
        ...
        for (int i = 0; i < times; i++) {
            ...
            flare::cord_buf buf;
            flare::cord_buf_as_zero_copy_output_stream stream(&buf);
            res = flare::json2pb::proto_message_to_json(data, &stream, &error1);
            timer.stop();
            avg_time2 += timer.u_elapsed();
            ASSERT_TRUE(res);
        }
    ...
    TEST_F(ProtobufJsonTest, encode_decode_case) {
        ...
        ASSERT_FALSE(flare::json2pb::encode_name(json_key, field_name));
        ASSERT_TRUE(field_name.empty());
        std::string json_key_decode;
        ASSERT_FALSE(flare::json2pb::decode_name(field_name, json_key_decode));
        ASSERT_TRUE(json_key_decode.empty());

        json_key = "_Afledk2e*_+%leGi___hE_Z278_t#";
        field_name.clear();
        flare::json2pb::encode_name(json_key, field_name);
        ...
        flare::json2pb::decode_name(field_name, json_key_decode);
        ...
        ASSERT_FALSE(flare::json2pb::encode_name(empty_key, empty_result));
        ASSERT_TRUE(empty_result.empty() == true);
        ASSERT_FALSE(flare::json2pb::decode_name(empty_result, empty_key));
    ...
    TEST_F(ProtobufJsonTest, json_to_zero_copy_stream_normal_case) {
        ...
        flare::cord_buf iobuf;
        flare::cord_buf_as_zero_copy_output_stream wrapper(&iobuf);
        std::string error;
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(person, &wrapper, &error)) << error;
    ...
    TEST_F(ProtobufJsonTest, zero_copy_stream_to_json_normal_case) {
        ...
        flare::cord_buf_as_zero_copy_input_stream wrapper(iobuf);
        Person person;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(&wrapper, &person));
    ...
    TEST_F(ProtobufJsonTest, extension_case) {
        ...
        Person person;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &person));
        ASSERT_STREQ("coding", person.GetExtension(addressbook::hobby).data());
        std::string output;
        ASSERT_TRUE(flare::json2pb::proto_message_to_json(person, &output));
    ...
    TEST_F(ProtobufJsonTest, string_to_int64) {
        ...
        Person person;
        std::string err;
        ASSERT_TRUE(flare::json2pb::json_to_proto_message(json, &person, &err)) << err;
